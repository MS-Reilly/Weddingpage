...
type IrlandaHighlightsSectionProps = {
  sectionTitle: string;
  sectionSubtitle?: string;
  locationLabel: string;
  items: IrlandaHighlightItem[];
};

export default function IrlandaHighlightsSection({
  sectionTitle,
  sectionSubtitle,
  locationLabel,
  items,
}: IrlandaHighlightsSectionProps) {
  return (
