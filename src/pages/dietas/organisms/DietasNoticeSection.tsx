type DietasNoticeSectionProps = {
  eyebrow: string;
  title: string;
  description: string;
};

export default function DietasNoticeSection({
  eyebrow,
  title,
  description,
}: DietasNoticeSectionProps) {
  return (
    <section className="floral-section-gray bg-gradient-to-r from-brand-500 to-brand-200 py-16">
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-white/70 bg-white/70 p-8 text-center shadow-soft">
