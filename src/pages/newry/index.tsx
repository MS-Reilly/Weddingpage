...
import pageData from "./data/newry.json";
import detailsData from "./data/details.json";
import DetailsSection from "./organisms/DetailsSection";
import NewryHighlightsSection from "./organisms/NewryHighlightsSection";
...
import videoWeb from "@assets/videos/Video1.mp4";

export default function NewryPage() {
